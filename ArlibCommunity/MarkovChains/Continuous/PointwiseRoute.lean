...
useless.  The whole argument is one line of algebra, `ArlibCommunity.PointwiseRoute.window_of_tvLe`:
...
namespace ArlibCommunity.PointwiseRoute
...
end ArlibCommunity.PointwiseRoute
