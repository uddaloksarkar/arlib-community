...
-/
import ArlibCommunity.Lattice.Rounding.ContTent
import ArlibCommunity.Lattice.KV97.Inflate
...
`ArlibCommunity.Lattice.Rounding.setIntegral_prodTent_compl_inflate_le_exp`, which
...
open MeasureTheory ArlibCommunity.Lattice.Rounding
...
`p` variable (`ArlibCommunity.Lattice.Rounding.integral_prodTent`), hence to at most `1`
...
escapes (`ArlibCommunity.Lattice.Rounding.setIntegral_prodTent_compl`); the sampler's
